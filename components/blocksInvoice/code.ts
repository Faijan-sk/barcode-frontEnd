export const flightInvoiceMain = `  <section className="order__section pt__60 pb__60">
      ...
      <div className="col-xxl-8 col-xl-10 col-lg-12">
         <div className="order__wrappers invoice__wrapper">
            ...
            <div className="transaction__dating mb__40 d-flex align-items-center">
               <img src="assets/img/details/reapp.png" className="reapp" alt="img"/>
               ...
               <img src="assets/img/details/qr.jpg" className="qu__code" alt="qr-code"/>
            </div>
            <p className="note">
               Note : This is computer generated receipt and does not require physical signature.
            </p>
            <div className="print__point__btn d-flex align-items-center gap-3">
               <Link href="/print" className="cmn__btn">
                  <span>
...
export const invoiceMain = `     <section className="order__section pt__60 pb__60">
<div className="container">
   <div className="row justify-content-center">
      <div className="col-xxl-8 col-xl-10 col-lg-12">
         <div className="order__wrappers invoice__wrapper">
            ...
            <div className="invoice__journey mb__30">
               <h5 className="dtext border__bottom">
                  Journey Details
               </h5>
...
export const emailInvoice = `      <section className="order__section pt__60 pb__60">
<div className="container">
   <div className="row justify-content-center">
      <div className="col-xxl-8 col-xl-10 col-lg-12">
         <div className="hotel__emailinvoice invoice__wrapper train__temail ">
            ...
            <div className="reservation__contetn pb__30 mb__30">
               ...
               <div className="input-esingl input-check d-flex align-items-center gap-2 payment__save mb__15">
                  <img src="assets/img/svg/over-check.svg" className="overcheck" alt="img"/>
                  <label for="saveForNextcard" className="gratext fz-18 fw-600 lato">Thank you! Your reservation has been confirmed.</label>
               </div>
            ...
            <h5 className="dtext fw-700 passengertitle">
               Passenger Details 
            </h5>
