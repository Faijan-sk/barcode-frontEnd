      ...
      <div className="accordion__wrap">
        <div className="accordion" id="accordionExample5">
          ...
          <div className="accordion-item wow fadeInUp" data-wow-duration="1s">
            <h2 className="accordion-header" id="headingTwo5">
              <button
          ...
          <div className="accordion-item wow fadeInUp" data-wow-duration="1.6s">
            <h2 className="accordion-header" id="headingThreem5">
              <button
                className="accordion-button collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapseThreem5"
                aria-expanded="false"
                aria-controls="collapseThreem5"
              >
            ...
            <div
              id="collapseThreem5"
              className="accordion-collapse collapse"
              aria-labelledby="headingThreem5"
              data-bs-parent="#accordionExample5"
            >
              <div className="accordion-body">
                <p>
